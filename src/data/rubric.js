...
export const VERDICT_TIERS = [
  ...
  },
  {
    ...
    description: 'The brand is distinctive, integrated, and defining its category. Identity, expression, and execution are pulling in one direction. Audiences seek it out. Competitors react to it. Protect the edge: the moment this softens into corporate wallpaper, the howl becomes a whisper again.',
  },
];
